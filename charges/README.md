...
*If your molecule is charged, you will need to adjust the multiplicity settings in antechamber (script 0) and the total charge settings in the resp fitting procedure (script 3)*
    * *The charge and multiplicity of the input qm xyz files generated by mdgx in script 2 should automatically adjust themselves, but I have not tested this*
